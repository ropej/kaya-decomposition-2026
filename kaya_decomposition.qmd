...
cluster_data |>
  ...
  select(cluster, `Počet zemí`,
         ...
         `Terciární vzdělání (% med.)`, `Příklady`) |>
  kableExtra::kbl(booktabs = TRUE,
                  align = c("c", "c", "c", "c", "c", "c", "c", "c", "c", "c", "l")) |>
...
-   **Chudé, zalidněné a strukturálně nestabilní ekonomiky** (shluk 3): Emise jsou relativně stabilní, ale jejich vývoj je silně ovlivňován změnami energetické a uhlíkové náročnosti a populačním růstem spíše než ekonomickým růstem.

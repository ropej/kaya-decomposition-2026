...
fossil_data <- bind_rows(
  ...
  ungroup() |>
  mutate(hodnota = factor(hodnota, levels = c(
    "Ano", "Ne", "Exportér FF", "Importér / neutrální", "Neuvedeno"
  )))
...
leaflet(map_data) |>   
  addPolygons(     
    ...
    label       = ~paste0(country, ": ",                        
                          scales::number(co2_pc, accuracy = 0.1,                                          decimal.mark = ","), " t CO₂/ob."),     
...
fviz_nbclust(X, kmeans, method = "wss") +
  labs(title = NULL, x = "Počet clusterů k", y = "Celková suma čtverců uvnitř clusterů")
```
